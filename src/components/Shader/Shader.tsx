/*
 * WebGL2 flow-field shader, rendered to a canvas that fills its container.
 * Size it with CSS; pass background.dark/background.light as #rrggbb to
 * match the page's theme colours.
 */
...
const float HUE = 0.47706601;
const float HUE_SPREAD = 0.421399534;
const float HUE_TRAVEL = 1.66118467;
const float CHROMA = 0.0843178853;
const float LIGHTNESS = 0.612533152;
const float COLOUR_CYCLE = 0.196620092;
const float THETA = 2.13802576;
const float SHEAR = 0.96133554;
const float SHRINK = 0.952760816;
const float LAYERS = 88.0;
const float WARP_FREQ_X = 0.532685816;
const float WARP_FREQ_Y = 2.62897491;
const float WARP_AMP_X = 0.125174433;
const float WARP_AMP_Y = 0.0317976251;
const float ASPECT_X = 1.98000097;
const float ASPECT_Y = 0.17910637;
const float OFFSET_X = 0.395291448;
const float OFFSET_Y = -0.0531856045;
const float TILT = 2.04384756;
const float ZOOM = 1.17962861;
const float CENTRE_X = -0.576711476;
const float CENTRE_Y = -0.202203155;
const float GLOW_SIZE = 0.00195283419;
const float FALLOFF = 0.491814226;
const float VIGNETTE = 0.0514461696;
const float FLOW_SPEED = 0.530538797;
const float FLOW_DIRECTION = 1.0;
const float BREATH_RATE = 0.550381839;
const float BREATH_AMOUNT = 0.0621033832;
const float PHASE = 81.6872864;
const float ECHO = 0.0;
const float ECHO_SHIFT = -0.138327613;
const float SOFTNESS = 0.00165618525;
const float LIGHT_SWING = 0.219860911;
...
const float uStrength = 1.23043919;
const float uScale = 1.17267072;
const float uSeed = 0.795830131;
